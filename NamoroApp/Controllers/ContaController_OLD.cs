...
namespace NamoroApp.Controllers
{
    ...
    public class ContaController_OLD : ControllerBase
    {
        private readonly DataContext _context;

        public ContaController_OLD(DataContext context)
        {
            _context = context;
        }
        ...
        {
            if (await LoginExiste(cadastroDto.Login.ToLower())) return BadRequest("Login Existe");
